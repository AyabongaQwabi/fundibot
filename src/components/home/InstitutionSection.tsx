...
const institutions = [
  ...
  { abbr: 'SU', name: 'Stellenbosch University', province: 'Western Cape', type: 'University', programmes: 155, color: 'bg-maroon-700 bg-red-800' },
      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6'>
        <div className='flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between'>
          <div>
            ...
            <h2 className='text-3xl font-extrabold tracking-tight text-slate-900 sm:text-4xl'>
              Explore South African Institutions
            </h2>
            <p className='mt-3 text-lg text-slate-500'>
              Every university, UoT, and TVET college in one place.
            </p>
          </div>
        ...
        <div className='mt-12 flex gap-5 overflow-x-auto pb-4 scrollbar-hide'>
          ...
          >
            ...
            <p className='mt-3 text-sm font-semibold text-slate-700'>View All Institutions</p>
