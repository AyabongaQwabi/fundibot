...
const conversation = [
  ...
  },
  {
    role: 'fundibot',
    avatar: 'F',
    message: "APS 34 works at several good options:\n\n**BSc Computer Science** — UCT needs 36, but Stellenbosch and UP both take from 34.\n\n**Diploma in IT** — CPUT, TUT, and DUT all accept from 28, so you're well above the bar.\n\n**BCom Informatics** — Wits and UJ both accept from 32. You qualify.",
    time: '2 min ago',
  },
];
      ...
      <div className={`max-w-[80%] ${isStudent ? 'items-end' : 'items-start'} flex flex-col gap-1`}>
        <div className={`rounded-2xl px-4 py-3 text-sm leading-relaxed ${
          isStudent
            ...
            : 'rounded-tl-sm bg-sky-600 text-white/90 border border-white/10'
        }`}>
          {msg.message.split('\n\n').map((para, i) => (
...
export function AIChatSection() {
  return (
    <section className='relative overflow-hidden bg-sky-800 py-24 sm:py-32'>
        ...
        <div className='grid items-center gap-16 lg:grid-cols-2'>
          <div>
            ...
            <h2 className='text-3xl font-extrabold tracking-tight text-white sm:text-4xl lg:text-5xl'>
              Answers based on{' '}
              <span className='text-gradient-blue'>your marks. Not someone else's.</span>
            </h2>
            <p className='mt-6 text-lg leading-relaxed text-white/60'>
              Generic advice is useless. Our tools match results to your actual subjects and percentages — not an average student's.
            </p>
            ...
            <div className='mt-8 space-y-4'>
              {[
                ...
                'Which careers match what I\'m good at?',
              ].map((q) => (
          ...
          <div className='rounded-2xl border border-white/10 bg-sky-700/60 backdrop-blur-sm'>
            <div className='flex items-center gap-3 border-b border-white/10 px-5 py-4'>
              ...
              <div>
                ...
                <div className='flex items-center gap-1.5'>
                  ...
                  <span className='text-xs text-white/40'>Online · No waiting</span>
                </div>
              </div>
            </div>
            ...
            <div className='border-t border-white/10 px-5 py-4'>
              <div className='flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 px-4 py-2.5'>
                <span className='flex-1 text-sm text-white/30'>Type your subjects and marks...</span>
                <Link href='/tools/course-finder' className='flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-lg bg-brand-blue'>
